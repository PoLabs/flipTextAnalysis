...
test_that("Handling of subsets (filters) and blank responses", {
    ...
    expect_equal(wb.blanks$sample.description, "n = 102 cases used to process the text of a total of 120; 18 cases are blank")
    ...
    expect_equal(wb.blanks.subset$sample.description, "n = 78 cases used to process the text of a total of 96 (my.test.subset); 18 cases are blank")
    ...
    expect_equal(wb.blanks.subset.named$sample.description, "n = 78 cases used to process the text of a total of 96 (Doesn't mention 'favourite'); 18 cases are blank")
